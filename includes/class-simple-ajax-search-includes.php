 ...
 */
class Simple_Ajax_Search_Includes {
	...
	private function load_dependencies() {
		 ...
		 * example: require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-simple-ajax-search-class-name.php';
		 * example: $class_name = new Simple_Ajax_Search_Class_Name( $this->get_plugin_name(), $this->get_version() );
		 */
	}
